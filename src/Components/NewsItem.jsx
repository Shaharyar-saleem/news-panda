  ...
  render() {
    ...
    return (
      <>
        ...
        <span class="badge rounded-pill bg-success" style={{ position: 'absolute', top: '12px', right: '13px', padding: '10px 20px'}}>{source}</span>
          ...
          <div className="card-body bg-light" style={{ height: "310px", padding: "30px 40px"}}>
            ...
            <p class="card-text"><small class="text-muted">Written By <b>{author ? author : 'Unknown'}</b> on <b>{date.toUTCString()}</b></small></p>
